...
const PolicyPayment = () => {
  ...
  const create_policy_eventCallback = async (
    policyHolder: string,
    policyNumber: number,
    ...
    if (policyNumber >= 0) {
      toast({
        title: "Policy Created Successfull !",
        status: "success",
        position: "top",
      });
  ...
  const payCreatePolicy = async () => {
    ...
    if (petInfoContext) {
      ...
      await create_pet_policy(
        petIpfsLink,
        premiumEth,
        create_policy_eventCallback
      );
    }
  };
        ...
        <Container flex="1">
          ...
          >
            {petInfoContext ? (
              paymentSuccess ? (
                <>
                  <PolicyPaymentSuccess policyNo={policyNo} />
                </>
              ) : (
                <>
                  <Text
                  ...
                  >
                    ...
                    <Box
                      ...
                      height="20px"
                    >
                      {petInfoContext.age.years} years,{" "}
                      {petInfoContext.age.months} months
                    </Box>
                    <Box
                      color={useColorModeValue("yellow.600", "palegoldenrod")}
                      fontWeight={"bold"}
