            ...
            <Box as="section" bg="bg-surface" py={{ base: '12', md: '2' }} minH='sm'>
                ...
                <br/>
                    <SimpleGrid textAlign={'center'} columns={2} spacingX='20px' spacingY='10px' >
                        <Box color={useColorModeValue('yellow.600', 'palegoldenrod')} fontWeight={'bold'} height='20px'>Policy Number:</Box>
                        <Box fontStyle={'italic'} fontFamily={'cursive'} fontWeight={'semibold'}   height='20px'>{petPolicyDetails.policyNumber}</Box>
                        <Box color={useColorModeValue('yellow.600', 'palegoldenrod')} fontWeight={'bold'} height='20px'>Policy Amount Insured:</Box>
                        <Box fontStyle={'italic'} fontFamily={'cursive'} fontWeight={'semibold'}   height='20px'>{petPolicyDetails.max_amount_insured} Aud($)</Box>
                        <Box color={useColorModeValue('yellow.600', 'palegoldenrod')} fontWeight={'bold'} height='20px'>Policy Start:</Box>
                        <Box fontStyle={'italic'} fontFamily={'cursive'} fontWeight={'semibold'}   height='20px'>{petPolicyDetails.createdTime}</Box>
                        <Box color={useColorModeValue('yellow.600', 'palegoldenrod')} fontWeight={'bold'} height='20px'>Policy End:</Box>
                        <Box fontStyle={'italic'} fontFamily={'cursive'} fontWeight={'semibold'}   height='20px'>{petPolicyDetails.endTime}</Box>
                        <Box color={useColorModeValue('yellow.600', 'palegoldenrod')} fontWeight={'bold'} height='20px'>Policy Holder:</Box>
                        ...
                        <Box color={useColorModeValue('yellow.600', 'palegoldenrod')} fontWeight={'bold'} height='20px'>PreMedical Condition:</Box>
